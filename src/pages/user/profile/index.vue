...
<template>
  <view>
    <wd-navbar title="个人资料" safe-area-inset-top fixed placeholder left-arrow @click-left="goBack" />
    ...
    <view style="padding: 16px;">
      ...
      <wd-cell-group border>
        <wd-input v-model="oldPassword" label="原密码" label-width="80px" placeholder="请输入原密码" show-password />
        <wd-input v-model="newPassword" label="新密码" label-width="80px" placeholder="请输入新密码" show-password />
        <wd-input v-model="confirmNewPassword" label="确认密码" label-width="80px" placeholder="请再次输入新密码" show-password />
      </wd-cell-group>
      <view style="margin-top: 16px;">

...
<template>
  <view>
    ...
    <view style="padding: 16px; background: linear-gradient(180deg, #4D80F0 0%, #ffffff 100%); margin-bottom: 12px;">
    ...
    <wd-cell-group>
      ...
      <wd-cell v-if="userStore.isAdmin" title="用户管理" icon="user" is-link @click="goManageUsers" />

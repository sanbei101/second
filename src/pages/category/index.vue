...
<template>
  <view>
    ...
    <wd-sidebar v-model="activeIndex" style="height: calc(100vh - 44px - env(safe-area-inset-bottom));">
      ...
      >
        <view style="display: flex; gap: 12px;">
          ...
          <view style="flex: 1;">
            ...
            <view style="margin-top: 8px; display: flex; align-items: center; justify-content: space-between;">
